...
# have rows ready for interpolation

library(ggplot2)
ggplot(litter_C_A_2019,aes(x = Date_collected, y = All_Leaf)) + geom_point()
...
```{r}
# attempt to graph all traps in control plot interpolated
...
ggplot(litter_S_daily,aes(x = Date_collected, y = All_Leaf, color = Trap)) + geom_point()
...
ggplot(litter_F_daily,aes(x = Date_collected, y = All_Leaf, color = Trap)) + geom_point()
```
